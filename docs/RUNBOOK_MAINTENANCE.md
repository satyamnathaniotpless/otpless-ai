...
| **Upstream qm merge** | Monthly | Core stays byte-identical to upstream except our layer (ADR-001). Merge conflicts in `deploy/layers/otpless/` are ours; conflicts in core mean we diverged and should ask why. |
